...
const MpreviouswroomFiles = {
    ...
    'firmware': /resources\/PREVIOUS\/(.*)_old_hardware.bin/,
};
...
const MlatestwroomFiles = {
    ...
    'firmware': /resources\/CURRENT\/(.*)_old_hardware.bin/,
};
...
const MV6previousFiles = {
    ...
    'partitions': 'resources/STATIC/M/ESPWROOM/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/ESPWROOM/core/boot_app0.bin',
    'firmware': /resources\/PREVIOUS\/(.*)_v6.bin/,
};
...
const MV6latestFiles = {
    ...
    'partitions': 'resources/STATIC/M/ESPWROOM/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/ESPWROOM/boot_app0.bin',
    'firmware': /resources\/CURRENT\/(.*)_v6.bin/,
};
...
const MV6_1previousFiles = {
    ...
    'partitions': 'resources/STATIC/M/ESPWROOM/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/ESPWROOM/core/boot_app0.bin',
    'firmware': /resources\/PREVIOUS\/(.*)_v6_1.bin/,
};
...
const MV6_1latestFiles = {
    ...
    'partitions': 'resources/STATIC/M/ESPWROOM/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/ESPWROOM/boot_app0.bin',
    'firmware': /resources\/CURRENT\/(.*)_v6_1.bin/,
};
...
const MKitpreviousFiles = {
    ...
    'partitions': 'resources/STATIC/M/ESPWROOM/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/ESPWROOM/core/boot_app0.bin',
    'firmware': /resources\/CURRENT\/(.*)_kit.bin/,
};
...
const MV6MinipreviousFiles = {
    ...
    'partitions': 'resources/STATIC/M/ESPWROOM/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/ESPWROOM/core/boot_app0.bin',
    'firmware': /resources\/PREVIOUS\/(.*)_mini.bin/,
};
...
const MV6MinilatestFiles = {
    ...
    'partitions': 'resources/STATIC/M/ESPWROOM/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/ESPWROOM/boot_app0.bin',
    'firmware': /resources\/CURRENT\/(.*)_mini.bin/,
};
...
const MS3previousiles = {
    ...
    'firmware': /resources\/PREVIOUS/(.*)_multiboardS3.bin/,
};
...
const MS3latestFiles = {
    ...
    'firmware': /resources\/CURRENT\/(.*)_multiboardS3.bin/,
};
...
const MDevPropreviousFiles = {
    ...
    'firmware': /resources\/PREVIOUS\/(.*)_dev_board_pro.bin/,
};
...
const MDevProlatestFiles = {
    ...
    'firmware': /resources\/CURRENT\/(.*)_dev_board_pro.bin/,
};
...
const MD1MinipreviousFiles = {
    ...
    'partitions': 'resources/STATIC/M/DEVPRO/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/DEVPRO/core/boot_app0.bin',
    'firmware': /resources\/PREVIOUS\/(.*)_lddb.bin/,
};
...
const MD1MinilatestFiles = {
    ...
    'partitions': 'resources/STATIC/M/DEVPRO/esp32_marauder.ino.partitions.bin',
    'boot_app0': 'resources/STATIC/M/DEVPRO/boot_app0.bin',
    'firmware': /resources\/CURRENT\/(.*)_lddb.bin/,
};
